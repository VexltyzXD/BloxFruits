...
KeyTab:AddKeyBox(examplekey, function(Success)  --you can also add another variable to get the text currently in keybox, here is how: function(Success, RecivedKey) recived key is the input
	if Success then
