...
TitleText.Text = "God Mode Blox Fruits [ VeLix Hub ]"
...
DescLabel.Text = "Immortality [ Premium only feature]"
...
GodOnButton.Text = "START GOD MODE"
...
GodOffButton.Text = "TURN OFF GOD MODE"
...
InfoLabel.Text = "VIP Features:\n• Infinite Health\n• Anti Void\n• Self-Healing Upon Taking Damage\n• Reset to activate 🟢"
...
pcall(function()
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "God Mode - Blox Fruits [ VeLix Hub ]",
        Text = "Device Optimization in Progress",
        Duration = 5
    })
end)
