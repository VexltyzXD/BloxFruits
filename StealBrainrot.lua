...
local CHIRON_TEXT = "VeLix Hub | Game"
...
-- ── FLOATING CH CIRCLE LOGO (outside panel, click to toggle UI) ──
local chSize = 48
...
pbar.Position = UDim2.new(0.5, -PBAR_W/2, 1, -110)  -- moved up from -60 to -110
...
-- Rotating gradient border stroke
