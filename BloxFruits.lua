...
local FolderName = "VeLix Hub | Premium"
local FileName = "VeLix Hub Premium.json"
...
-- =========================================================
-- AUTO FISHING SYSTEM (Ported from VeLix Hub)
-- =========================================================
        ...
        pcall(function()
            while wait(Sec) do
                if _G.Auto_Rainbow_Haki then
                    -- Copy logic Rainbow Haki từ file BloxFruits.lua (dòng 2058-2154) vào đây nếu cần
